...
class SenseAndAvoid
{
  ...
  private:
    ...
    int left_count, right_count, prev_left_enc, prev_right_enc;
...
{
  left_count += msg->data - prev_left_enc;
  prev_left_enc = msg->data;
}
 
void SenseAndAvoid::rightEncoderCallback(const std_msgs::Int16::ConstPtr& msg)
{
  right_count = msg->data - prev_right_enc;
  prev_right_enc = msg->data;
}
...
{
  ros::init(argc, argv, "autobot_control");
